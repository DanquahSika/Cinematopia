                    ...
                    <div className="w-full max-w-md bg-[#222] rounded-xl shadow-md py-8 px-8">
                        ...
                        <form className="flex flex-col">
                            ...
                            <p className="text-white mt-4 text-center">Already have an account?
                                <a className="text-white-500 hover:underline mt-4 px-1 ursor-pointer" onClick={() => setIsLogin(true)}>Log In</a>
                            </p>
                        </form>
                    </div>
                </div>
        ...
        <div className=" hero bg-212321-100 flex flex-col items-center justify-center min-h-screen md:py-2">
            <main className="flex items-center w-full px-2 md:px-20">
                <div className="hidden md:inline-flex flex-col flex-1 space-y-1">
                    ...
                    <p className='font-medium text-lg leading-1 text-orange-100'>Cinematopia - Your Gateway to Streaming Excellence</p>
                </div>
