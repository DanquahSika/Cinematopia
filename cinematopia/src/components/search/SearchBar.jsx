...
const SearchBar = () => {
  return (
    // <nav className="flex flex-col lg:flex-row justify-between items-center bg-black text-emerald-50 lg:h-14 py-3 lg:py-0">
    ...
    //     <Link to="/" className="mr-4 mb-2 lg:mb-0">
    //       <span>Home</span>
    //     </Link>
    //     <Link to="/genre" className="mr-4 mb-2 lg:mb-0">
    //       <span>Genre</span>
    //     </Link>
    //     <Link to="/movies" className="mr-4 mb-2 lg:mb-0">
    //       <span>Movies</span>
    //     </Link>
    //     <Link to="/tvshows" className="mr-4 mb-2 lg:mb-0">
    //       <span>TV Shows</span>
    //     </Link>
    //   </div>
    //   <form className="mr-5">
    //     <input
    //       type="text"
    //       className="block w-full lg:w-64 h-8 rounded-md border-0 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-gray-400 sm:text-sm sm:leading-6"
